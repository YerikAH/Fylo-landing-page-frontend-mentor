...
const HeroSection = () => {
  return (
    <section className='grid place-items-center w-full'>
      ...
      <h1 className='text-white text-2xl font-serif text-center font-bold mt-4'>
        All your files in one secure location, accessible anywhere
      </h1>
      <p className='text-white text-sm font-sans text-center mt-4 px-4'>
      ...
      <button
        tabIndex={1}
        className='mt-8 text-white text-sm py-4 px-20  text-center  font-bold  font-serif button-started'
      >
        Get Started
      </button>
    </section>
